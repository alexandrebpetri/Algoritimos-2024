...
//backend->frontend
function carregarComidasPredefinidas() {
    const comidasPredefinidas = [
        new Comida (1, "Iogurte", 54, "Frimesa"),
    ];

    listaComida = comidasPredefinidas;
    listar(); // Exibe os comidas na tela
}
...
function salvar() {
    ...
    const distribuidor = document.getElementById("inputDistribuidora").value;
    ...
    if (id && nome && peso && distribuidor) {// se tudo certo 
        switch (oQueEstaFazendo) {
            case 'inserindo':
                ...
                break;
            case 'alterando':
                comidaAlterada = new Comida(id, nome, peso, distribuidor);
                listaComida[comida.posicaoNaLista] = comidaAlterada;
...
function mostrarDadosFilme(comida) {
    ...
    document.getElementById("inputDistribuidora").value = comida.distribuidor;
...
function limparAtributos() {
    ...
    document.getElementById("inputDistribuidora").value = "";
...
function bloquearAtributos(soLeitura) {
    ...
    document.getElementById("inputDistribuidora").readOnly = soLeitura;
}
